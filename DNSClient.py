...
local_host_ip = '127.0.0.1'  # localhost IP address for local DNS server
...
if __name__ == '__main__':
    ...
    print(f"\nComparison result (all IPs match): {result}")
    
    # Test query for nyu.edu
    result = query_local_dns_server('nyu.edu.', question_type)
    print(f"\nTest query for nyu.edu: {result}")
